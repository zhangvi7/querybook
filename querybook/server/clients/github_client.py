...
class GitHubClient:
    def __init__(self, github_link: GitHubLink, datadoc: DataDoc):
        """
        ...
        self.branch = "main"
        self.file_path = self._build_file_path(datadoc)
    ...
    def _build_file_path(self, datadoc: DataDoc) -> str:
    ...
    def get_datadoc_versions(self) -> List[Dict]:
        """
        ...
        """
        try:
            commits = self.repo.get_commits(path=self.file_path, ref=self.branch)
